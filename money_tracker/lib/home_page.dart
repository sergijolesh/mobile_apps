                ...
                if (cost != null) { 
                  ...
                  try { 
                    final response = await http.post( 
                      Uri.parse('http://192.168.43.245:5000/api/post-expenses'), 
              ...
              Expanded( 
                child: GridView.builder( 
                  ...
                  itemBuilder: (context, index) { 
                    ...
                    final Color color = (index < colors.length) ? colors[index] : Colors.grey; 
        ...
        onTap: (index) { 
          if (index == 1) { 
            Navigator.push( 
              context, 
              MaterialPageRoute( 
                builder: (context) => StatisticsPage(apiBaseUrl: 'http://192.168.43.245:5000'), 
              ), 
            ); 
          } else if (index == 2) { 
            Navigator.push( 
